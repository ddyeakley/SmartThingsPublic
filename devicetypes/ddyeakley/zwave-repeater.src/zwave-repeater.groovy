 ...
 *  Version 2.01:  Modification to use switch instead of motion icon
 */
metadata {
	definition (name: "Z-Wave Repeater", namespace: "ddyeakley", author: "Dan Yeakley") {
	...
	tiles(scale: 2) {
		multiAttributeTile(name: "status", type: "generic", width: 6, height: 4) {
			tileAttribute("device.status", key: "PRIMARY_CONTROL") {
                attributeState "unknown", label: 'unknown', icon: "st.switches.switch.off", backgroundColor: "#ffffff"
				attributeState "online", label: 'online', icon: "st.switches.switch.off", backgroundColor: "#00A0DC"
				attributeState "offline", label: 'offline', icon: "st.switches.switch.off", backgroundColor: "#ffffff"
			}
		}
