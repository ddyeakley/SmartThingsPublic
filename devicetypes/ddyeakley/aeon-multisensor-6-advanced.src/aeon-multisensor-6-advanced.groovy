 ...
 *  Version 1.0.3 (12/15/17) - ddyeakley use 
 *
 ...
 */
 ...
 metadata {
	definition (name: "Aeon Multisensor 6 (Advanced)", namespace: "ddyeakley", author: "Dan Yeakley") {
	...
	tiles (scale: 2) {
        ...
        standardTile("motion","device.motion", inactiveLabel: false, width: 6, height: 4) {
		...
		details([
            ...
            "ultravioletIndex","tamper","configure",
            "statusText2","refresh"
            ])
	}
}
